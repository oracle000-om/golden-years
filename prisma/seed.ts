...
async function main() {
    ...
    if (existingPolls === 0) {
        const polls = [
            /* ── Directly impacts seniors (surfaced to top) ── */
            {
                slug: 'age-based-adoption-fees',
                title: 'Waiving adoption fees for senior pets',
                statement:
                    'Senior pets (typically 7+ years) are the least likely to be adopted and the most likely to be euthanized. Some shelters waive adoption fees entirely for senior animals, while others worry this devalues the animal or attracts adopters who cannot afford ongoing vet care. Senior impact: fee waivers directly target the adoption gap that puts older animals on euthanasia lists.',
            ...
            },
            {
                ...
                statement:
                    'Some cities have explored or enacted moratoriums on shelter euthanasia for adoptable animals, pushing toward "no-kill" status (defined as saving 90%+ of intake). Critics say these policies can lead to overcrowded, underfunded shelters that harm animal welfare. Senior impact: seniors are the first to be euthanized when shelters reach capacity — moratoriums buy them the time they desperately need.',
            ...
            },
            {
                ...
                statement:
                    'Only 12 U.S. states require animal shelters to publicly report intake, adoption, euthanasia, and live-release rates. Advocates say transparency is essential to accountability; some shelters argue reporting burdens are unfair without additional funding. Senior impact: without age-disaggregated data, the disproportionate euthanasia of senior animals remains invisible to the public.',
            ...
            },
            {
                ...
                statement:
                    'Many landlords and homeowner associations prohibit specific breeds or impose weight limits. An estimated 25% of pets surrendered to shelters are given up due to housing restrictions. Senior impact: older pets surrendered due to housing changes are the hardest to re-home and the most likely to be euthanized.',
            ...
            /* ── Reframed for senior relevance ── */
            {
                slug: 'animal-limits-per-household',
                title: 'County-level animal limits',
                statement:
                    'Counties across the United States set limits on the number of domestic animals per household, often differentiating by species and property size. These ordinances vary widely — from 2 dogs in some urban areas to no limit in rural zones. When families hit these limits, senior pets are often the first to be surrendered because they are seen as less adoptable than younger animals.',
            ...
            },
            {
                ...
                statement:
                    'Several U.S. cities and counties require all pet dogs and cats to be spayed or neutered by a certain age, with exemptions for licensed breeders and show animals. Unaltered animals produce litters that flood shelters, pushing senior animals further down adoption queues and closer to euthanasia lists.',
            ...
            },
            {
                ...
                statement:
                    'Over 900 U.S. cities have passed laws banning or restricting ownership of specific dog breeds like pit bulls, Rottweilers, and others deemed dangerous. Major animal organizations including the ASPCA have opposed breed-specific bans. Senior pit bull-type dogs are already the hardest demographic to place — breed bans make their adoption nearly impossible in affected jurisdictions.',
            ...
            },
            {
                ...
                statement:
                    'Over 400 U.S. localities have banned the retail sale of commercially bred dogs and cats in pet stores, requiring stores to partner with shelters instead. The commercial breeding pipeline creates a steady supply of puppies that absorbs adopter demand, leaving senior shelter animals overlooked and at greater risk of euthanasia.',
            ...
            },
            {
                ...
                statement:
                    'Over 30 states have enacted laws regulating or banning the practice of chaining dogs outdoors for extended periods. Violations can range from fines to animal seizure. Senior dogs suffer disproportionately from prolonged tethering — age-related joint disease, muscle atrophy, and exposure are amplified, and many tethered seniors end up surrendered to shelters when their health declines.',
            ...
            /* ── New: replaces TNR ── */
            {
                ...
                statement:
                    'Senior shelter animals often require more medical attention than younger ones — dental cleanings, bloodwork, arthritis management, and tumor removals that many shelters cannot afford. Some advocates propose government subsidies to cover geriatric veterinary care for shelter animals, arguing it would make seniors more adoptable and reduce euthanasia of treatable animals.',
                forTitle: 'I support veterinary subsidies',
                forArgument:
                    'Senior animals are euthanized not because they are unadoptable, but because shelters cannot afford to treat manageable conditions. A $500 dental cleaning can make a 10-year-old dog adoptable overnight. Public funding for senior pet care would save lives and reduce the long-term cost of sheltering.',
